...
- **Highest-risk areas:** auth/session flows, self-service registration, invite creation and acceptance, tenant user-management routes, restricted-vs-full-access enforcement, tenant-wide profile/scoping routes, dashboard/snapshot/reporting APIs, evidence upload and quota enforcement, evidence lock/unlock workflows, admin-only endpoints, and file-upload/report-export code.
